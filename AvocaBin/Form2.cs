    ...
    public partial class Form2 : Form
    {
        ...
        private void crystalReportViewer1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                CrystalReport1 i = new CrystalReport1();

                //cnx.ConnectionString=ConfigurationManager.ConnectionStrings[]
                ...
                {
                    i.DataSourceConnections[0].IntegratedSecurity = false;
                    i.DataSourceConnections[0].SetConnection(strServer, strDatabase, strUserID, strPwd);
                }
                else
                {
                    i.DataSourceConnections[0].SetConnection(strServer, strDatabase, true);
                }

                i.SetParameterValue("id_plainte", id_plainte);
                crystalReportViewer1.ReportSource = i;
